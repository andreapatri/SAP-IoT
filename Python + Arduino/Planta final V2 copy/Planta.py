...
try:
	...
	canvas.create_text(810, 550, text="7", fill="gray", font="Helvetica 200 bold",tag="T2")
	canvas.create_text(1250, 550, text="0", fill="gray", font="Helvetica 200 bold",tag="T3")
	canvas.create_text(1690, 550, text="1", fill="gray", font="Helvetica 200 bold",tag="T4")
	do_update()
	root.mainloop()
