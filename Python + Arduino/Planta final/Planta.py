...
def sensores(x,y):
	...
	canvas.create_text(465, 150, text=y, fill="gray", font="Helvetica 45 bold",tag="T2")
...
#------------------------------------ MAIN -------------------------------------#  
try:
	canvas.create_text(190, 150, text="4", fill="gray", font="Helvetica 45 bold",tag="T1")
	canvas.create_text(465, 150, text="1", fill="gray", font="Helvetica 45 bold",tag="T2")
	canvas.create_text(330, 150, text=7, fill="gray", font="Helvetica 45 bold",tag="T3")
	do_update()
	root.mainloop()
